...
extension TelegramAPI {
    ...
    */
    public class User: Codable {
        ...
        public init(id: Int, is_bot: Bool, first_name: String, last_name: String? = nil, username: String? = nil, language_code: String? = nil, is_premium: Bool? = nil, added_to_attachment_menu: Bool? = nil, can_join_groups: Bool? = nil, can_read_all_group_messages: Bool? = nil, supports_inline_queries: Bool? = nil, can_connect_to_business: Bool? = nil, has_main_web_app: Bool? = nil, has_topics_enabled: Bool? = nil) {
            self.id = id
            self.is_bot = is_bot
...
extension TelegramAPI {
    ...
    */
    public class UniqueGift: Codable {
        ...
        public init(gift_id: String, base_name: String, name: String, number: Int, model: UniqueGiftModel, symbol: UniqueGiftSymbol, backdrop: UniqueGiftBackdrop, is_premium: Bool? = nil, is_from_blockchain: Bool? = nil, colors: UniqueGiftColors? = nil, publisher_chat: Chat? = nil) {
